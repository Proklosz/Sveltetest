import { c as create_ssr_component, g as getContext, a as subscribe, b as add_attribute, e as escape, s as setContext, v as validate_component } from "../../../chunks/ssr.js";
import { w as writable } from "../../../chunks/index.js";
/* empty css                      */const Hint = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let touched;
  let errors;
  let hideWhenError;
  let requiredError;
...
const css = {
  code: "input.svelte-3u3q0e{height:30px;width:40%;position:relative}",
  map: null
};
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  $$unsubscribe_form();
  return `<h1 data-svelte-h="svelte-frft4h">Registration</h1> <form><label for="name" data-svelte-h="svelte-bs9sy6">Name</label> <input type="text" name="name" class="svelte-3u3q0e"> <label for="email" data-svelte-h="svelte-1p9d3fm">Email</label> <input type="email" name="email" class="svelte-3u3q0e"> ${validate_component(HintGroup, "HintGroup").$$render($$result, { for: "email" }, {}, {
    default: () => {
      return `${validate_component(Hint, "Hint").$$render($$result, { on: "required" }, {}, {
        default: () => {
          return `${escape(requiredMessage)}`;
        }
  ...
  })} <label for="password" data-svelte-h="svelte-pepa0a">Password</label> <input type="password" name="password" class="svelte-3u3q0e"> ${validate_component(HintGroup, "HintGroup").$$render($$result, { for: "password" }, {}, {
    default: () => {
      return `${validate_component(Hint, "Hint").$$render($$result, { on: "required" }, {}, {
        default: () => {
          return `${escape(requiredMessage)}`;
        ...
        default: ({ value }) => {
          return `This field must have at least ${escape(value)} characters.`;
        }
        ...
        {
          default: ({ value }) => {
            return `This field must contain at least ${escape(value)} numbers.`;
          }
        }
      )}`;
    }
  })} <label for="passwordConfirmation" data-svelte-h="svelte-14qscnk">Password Confirmation</label> <input type="password" name="passwordConfirmation" class="svelte-3u3q0e"> ${validate_component(HintGroup, "HintGroup").$$render($$result, { for: "passwordConfirmation" }, {}, {
    default: () => {
      return `${validate_component(Hint, "Hint").$$render($$result, { on: "required" }, {}, {
        default: () => {
          return `${escape(requiredMessage)}`;
  ...
  })}<br> <button ${!$form.valid ? "disabled" : ""}>Submit</button> </form>`;
});
export {
  Page as default
};
